...
def limpiar_correos_procesados():
    ...
    if os.path.exists(archivo):
        ...
        print("ℹ No existe archivo de correos procesados")
...
def limpiar_viajes_creados():
    ...
    if os.path.exists(archivo):
        ...
        print("ℹ No existe archivo de viajes creados")
...
def limpiar_archivos_excel():
    ...
    if total_eliminados > 0:
        ...
        print("ℹ No se encontraron archivos Excel para eliminar")
...
def limpiar_logs():
    ...
    if eliminados == 0:
        print("ℹ No se encontraron archivos de log")
